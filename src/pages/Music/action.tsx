...
// 歌曲搜索
export const getSearchLists = async (keywords: string, offset: number = 0, limit: number = MUSIC_SEARCH_DEFAULT_LIMIT) => {
...
// 歌曲排行列表
export const getRankLists = async (idx: string = '1', offset: number = 0, limit: number = MUSIC_SEARCH_DEFAULT_LIMIT) => {
